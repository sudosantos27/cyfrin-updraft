...
contract TSwapPool is ERC20 {
        ...
        returns (uint256 liquidityTokensToMint)
    {
        if (wethToDeposit < MINIMUM_WETH_LIQUIDITY) {
            // @audit-info MINIMUM_WETH_LIQUIDITYis a constant and therefore is not required to be emitted
    ...
    function _addLiquidityMintAndTransfer(
        ...
        // written this is backwards, should be: (msg.sender, wethToDeposit, poolTokensToDeposit)
