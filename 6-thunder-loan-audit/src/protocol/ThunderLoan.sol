...
contract ThunderLoan is Initializable, OwnableUpgradeable, UUPSUpgradeable, OracleUpgradeable {
    ...
    /*//////////////////////////////////////////////////////////////
                            STATE VARIABLES
    //////////////////////////////////////////////////////////////*/
    mapping(IERC20 => AssetToken) public s_tokenToAssetToken; // e I think this maps th eunderlying token to it's assetToken
    ...
    mapping(IERC20 token => bool currentlyFlashLoaning) private s_currentlyFlashLoaning; // e probably a mapping that tells us if a token is in the middle of a flash loan
    ...
    function initialize(address tswapAddress) external initializer {
        ...
        s_feePrecision = 1e18;  // @audit-info magic numbers
    ...
    // @audit low you can not use rapy to repay a flash loan inside another flash loan
    ...
    // @audit-info this function is never used
