...
contract AssetToken is ERC20 {
    ...
    // a its the rate between the underlying and the asset token
    ...
    constructor(
        ...
        // are the ERC20s stored in AssetToken.sol instead of ThunderLoan?
    ...
    function transferUnderlyingTo(address to, uint256 amount) external onlyThunderLoan {
        // weird ERC20s?
        // qanswered what happens if USDC denylisted the thunderloan contract?
    ...
    function updateExchangeRate(uint256 fee) external onlyThunderLoan {
        ...
        // a this breaks. Is that an issue?
